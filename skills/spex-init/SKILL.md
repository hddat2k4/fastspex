---
name: spex-init
description: Initialize Fastspex in a project (greenfield or brownfield). Scaffolds spex/ and generates the memory/ steering set — product.md, tech.md, structure.md, constitution.md. Run once before /spex:spec.
---
# Fastspex: Init
